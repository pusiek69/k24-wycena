...
const NARZEDZIA = [
  {
    ...
    description: [
      ...
      'Atlas Plan, Keralini, Laminam) NIE używaj — te wycenia kalkulator na',
      'stronie. Interstone bywa też dystrybutorem Laminam, ale ceny spieku',
      'biorą się u nas z cennika, nie ze stanu magazynowego.',
      '',
